...
At work, have you ever been in a situation where you're describing an idea and a co-worker says, "Oh, I can put that together in an afternoon." Or, that same co-worker reads of a new _Show HN_ project on Hacker News and remarks, "That's so simple, I could build that in a couple of hours!"
...
This is not something that S3 and CloudFront provide _out of the box_.
...
With Aerobatic, all of that is [handled automatically](/docs/static-http-hosting) for you. Here is how Aerobatic handles some common scenarios with **no** special configuration on your part:
