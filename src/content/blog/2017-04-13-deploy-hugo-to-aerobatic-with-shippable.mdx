...
_This post originally appeared as a guest post on the [Shippable blog](http://blog.shippable.com/deploy-a-hugo-site-to-aerobatic-with-shippable)_
...
<Cli commands={['hugo', 'aero create -n shippable', 'aero deploy -d public']} />
...
<MdxImage screenshot src="/img/shippable/env-var.png" alt="Shippable Environment Variable" />
...
<MdxImage screenshot src="/img/shippable/site-live.png" alt="Shippable CI Build Log" />
...
<MdxImage screenshot src="/img/shippable/edit-github.png" alt="Edit live in GitHub" />
