...
<MdxImage src="https://www.aerobatic.com/media/blog/form-submit-webhook-google-sheet.png" alt="Form to webhook to Google sheet" />

If you're unfamiliar with Aerobatic static plugins, check out [this introduction](/docs/configuration/#plugins). The code examples for this post are based on the [form-submit-demo](https://form-submit-demo.aerobaticapp.com) [[source code](https://github.com/aerobatic/form-submit-demo)].
...
<YouTube videoId="67ZL7pJ52bM" />

<MdxImage
  sreenshot
  src="https://www.aerobatic.com/media/blog/zapier-google-sheets-screenshot1.png"
  alt="Figure 1: Zapier Gooogle Sheets Row Setup"
/>
