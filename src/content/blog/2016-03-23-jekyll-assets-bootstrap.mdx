...
import CheckboxList from '$components/mdx/CheckboxList';

<MdxImage align="center" alt="Bootstrap + Jekyll" src="https://www.aerobatic.com/media/blog/bootstrap-plus-jekyll.png" />
...
```html
<div class="dropdown">
  <button type="button" data-toggle="dropdown">Actions <span class="caret"></span></button>
...
<Cli>aero deploy --directory _site</Cli>
...
<link
  type="text/css"
  rel="stylesheet"
  href="//d2q4nobwyhnvov.cloudfront.net/450e1fc2-1d30-45c1-83dc-4b42937930a6/HnlPlK2VLUI2-A/assets/main.css"
/>
...
<script
  type="text/javascript"
  src="//d2q4nobwyhnvov.cloudfront.net/450e1fc2-1d30-45c1-83dc-4b42937930a6/HnlPlK2VLUI2-A/assets/main.js"
></script>
```
...
- Eliminated unnecessary Bootstrap CSS and JavaScript components reducing download sizes - Served off a global CDN
