...
<MdxImage src="/img/slack.svg" style={{ float: 'right' }} width={150} height={150} />
...
<MdxImage
  screenshot
  src="https://www.aerobatic.com/media/slack-create-app-screenshot.png"
  alt="Slack Create Application"
/>
...
<MdxImage
  screenshot
  src="https://www.aerobatic.com/media/slack-app-permissions.png"
  alt="Slack App Permissions"
/>
...
<MdxImage
  screenshot
  src="https://www.aerobatic.com/media/slack-app-scopes.png"
  alt="Slack App Scopes"
/>
...
<MdxImage
  screenshot
  src="https://www.aerobatic.com/media/slack-install-app.png"
  alt="Slack Install App"
/>
...
<MdxImage
  screenshot
  src="https://www.aerobatic.com/media/--2/slack-oauth-access-token.png"
  alt="Slack OAuth Token"
/>
...
<form id="inviteForm" method="POST">
  <input id="email" type="email" /> <button type="submit">Send Invite</button>
</form>
