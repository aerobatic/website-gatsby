...
<MdxImage border align="center" alt="Prelaunch flow" src="https://www.aerobatic.com/media/diagrams/aero-agency-flow-prelaunch.png" />
...
<MdxImage alt="Launch phase" src="https://www.aerobatic.com/media/--1/diagrams/aero-agency-flow-launch.png" border align="center" />
...
<Cli>aero deploy --message 'Turn off password-protect'</Cli>
...
<MdxImage src="https://www.aerobatic.com/media/diagrams/--1/aero-agency-flow-postlaunch.png" alt="Post Launch phase" />
...
<Cli>aero pr --stage preview --email sally@client.co --message 'Added new legal page'</Cli>
