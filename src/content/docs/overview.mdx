...
<MdxImage src="https://www.aerobatic.com/media/docs/cdn-world-map.png" alt="CDN World Map" />
...
You can follow your web logs in near real-time using the either the [aero logs](/docs/cli/#logs-command) command or in the web control panel. In addition to the usual web log fields such as URL, method, response code, etc. we also include the physical location of the end user by geo-location of their IP address.
