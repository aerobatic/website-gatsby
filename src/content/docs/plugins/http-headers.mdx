...
import { Alert, Link } from '$components/mdx';
...
<Alert type="warn">
  It's a good idea to test the security headers in a non-production{' '}
  <Link href="/docs/deployment/#deploy-stages">deploy stage</Link> before you roll it out in
  production.
</Alert>
