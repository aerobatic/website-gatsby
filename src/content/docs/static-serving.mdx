...
| `/blog/`           | `/blog/index.html==false`, `/blog.html == true`                               |                              | `/blog`      | `301`          |
| `/blog/`           | `/blog/index.html==false`, `/blog/index.xml == true`                          | `/blog/index.xml`            |              | `200` or `304` |
| `/blog/`           | `/blog/index.html==false`, `/blog/index.xml==false`, `/blog/index.json==true` | `/blog/index.json`           |              | `200` or `304` |
| `/blog`            | `/blog.html==false`, `/blog/index.html==true`                                 |                              | `/blog/`     | `301`          |
| `/blog/index`      |                                                                               |                              | `/blog/`     | `301`          |
| `/blog/index.html` |                                                                               |                              | `/blog/`     | `301`          |
| `/About-Us`        | `/About-Us.html==false`, `/about-us.html==true`                               |                              | `/about-us`  | `301`          |
