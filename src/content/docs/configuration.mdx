...
There are two ways to manage environment variables: with the [aero env](/docs/cli#env-command) CLI command and in the control panel web app.

**Set an environment variable**

<Cli>aero env --name BASIC_AUTH_PASSWORD --value password123NO</Cli>
