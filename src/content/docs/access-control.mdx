...
<Image src="/img/access-control-icon.png" style={{ float: 'right' }} width={233} height={207} />
...
<Cli>aero clientip --value "97.113.60.20/30,97.113.60.24/29,97.113.60.32/29,97.113.60.40/32"</Cli>
...
<Image
  src="https://www.aerobatic.com/media/docs/--1/blocked-client-ip.png"
  border
  width="600px"
  align="center"
  screenshot
...
<Cli>aero clientip --value '97.113.60.20/30' --stage test</Cli>

<Alert type="tip" style={{marginTop: '20px'}}>

Unlike the [password-protect](/docs/plugins/password-protect/) and [auth0](/docs/plugins/auth0/) plugins, client IP ranges are not configured in the `aerobatic.yml`. This means you can change them anytime with the CLI without having to re-deploy your site.
...
<Cli>aero clientip --value myip</Cli>

You can of course use this shortcut in conjunction with the `--stage` option:

<Cli>aero clientip --value myip --stage demo</Cli>
