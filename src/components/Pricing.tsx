...
const GetStartedButton = () => (<Link className="btn btn-success btn-lg" to="/docs/getting-started/">Get Started Now</Link>);
...
const PRICE_PLANS: IPricePlan[] = [
  {
    ...
    price: () => (<div className="price"><span className="amount">free</span></div>),
    active: false,
    detailLines: () => {
      return [
        <li key={0}>Unlimited deployments to https://<strong>your-site-name</strong>.aerobaticapp.com</li>,
  ...
  },
  {
    ...
    active: false,
    detailLines: () => [
      <li key={0}>50 sub-domains on single root domain, i.e.<br/>https://<strong>site1</strong>.custom.com,<br />https://<strong>site1</strong>.custom.com</li>,
      <li key={1}>Same benefits as Pro Plan</li>,
      <li key={2}><Link to="/blog/announcing-organization-pricing-plan/">Learn more →</Link></li>
    ],
    actionButton: () => <a className="btn btn-success btn-lg" href="mailto:support@aerobatic.com?subject=Org+plan+inquiry">Contact Us</a>
  }
];
